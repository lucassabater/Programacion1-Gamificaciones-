...
número de palabras, contenidas en la secuencia, que empiezan con el carácter introducido por
teclado a petición del programa. Hay que utilizar la clase Palabra.
    ...
    private void metodoPrincipal()throws Exception{
        ...
        while(Palabra.hayPalabras()){
            palabra.lectura();
              ...
              if (palabra.primerCaracter()==primer) {
             contador++;   
            }  
